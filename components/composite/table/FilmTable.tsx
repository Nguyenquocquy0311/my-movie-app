...
const FilmTable: React.FC = () => {
  ...
  const filmJson = [
  {
    ...
    type: "phim-le",
    desc: "A thief who steals corporate secrets through the use of dream-sharing technology is given a final chance at redemption if he can successfully perform an inception.",
  },
  {
    id: 2,
    title: "The Matrix",
  ...
  },
  {
    ...
    url: "https://www.youtube.com/watch?v=m8e-FF8MsqU",
    type: "phim-bo",
    desc: "A drama about a powerful and influential woman who becomes embroiled in a fierce struggle for control over her empire.",
  },
  {
    id: 4,
    title: "Interstellar",
  ...
  },
  {
    ...
    type: "phim-bo",
    desc: "The Avengers assemble once more in order to reverse the damage caused by Thanos in Infinity War.",
  },
  {
    id: 9,
    title: "Forrest Gump",
    ...
    type: "phim-bo",
    desc: "The presidencies of Kennedy and Johnson, the Vietnam War, the civil rights movement, the Watergate scandal and other historical events unfold from the perspective of an Alabama man with an IQ of 75.",
  },
  {
    id: 10,
  ...
  },
  {
    ...
    type: "phim-le",
    desc: "A hobbit and his companions set out on a quest to destroy a powerful ring and thwart the Dark Lord's plan to conquer Middle-earth.",
  },
  {
    id: 13,
    ...
    url: "https://www.youtube.com/watch?v=deB-q4LgW2k",
    type: "phim-le",
    desc: "A young farmer joins forces with a princess, a rogue pilot, and a wise old Jedi to combat a tyrannical empire and restore peace to the galaxy.",
  }
];
