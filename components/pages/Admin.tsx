    ...
    <>
      ...
      <div className="flex h-screen">
        ...
        <div className="flex flex-col ml-24 w-full h-full">
          <HeaderAdmin onClick={isPhimTabActive ? handleAddFilm : handleAddCategory} title={title} />
      ...
      {/* Modal add */}
      <AddFilmModal open={openAddFilm} onClose={handleClose} onSave={handleSave} />
      <AddCategoryModal open={openAddCategory} onClose={handleClose} onSave={handleSave} />
    </>
  );
}
